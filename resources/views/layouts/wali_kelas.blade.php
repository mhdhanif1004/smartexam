...
<body class="font-sans antialiased text-gray-800 dark:text-gray-200">
    <div x-data class="flex h-screen overflow-hidden bg-gray-100 dark:bg-gray-950">
        <x-sidebar :role="'wali_kelas'" />

        <div x-show="$store.sidebar.open" x-cloak @click="$store.sidebar.open = false" id="smartexam-sidebar-overlay-wali_kelas" data-turbo-permanent class="fixed inset-0 z-30 bg-gray-900/50 md:hidden"></div>
