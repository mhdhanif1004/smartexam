...
<button
    ...
    @click="visible = !visible; const field = $el.previousElementSibling; if (field && field.matches('input')) field.type = visible ? 'text' : 'password';"
    :aria-label="visible ? 'Sembunyikan password' : 'Tampilkan password'"
    {{ $attributes->merge(['class' => 'inline-flex items-center transition ' . $color . ' ' . $position]) }}
>
