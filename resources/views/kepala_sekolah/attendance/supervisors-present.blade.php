<x-layouts.kepala_sekolah title="Daftar Pengawas Hadir Hari Ini">
    <div class="space-y-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Daftar Pengawas Hadir Hari Ini</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Pengawas dengan status <span class="font-semibold text-emerald-600">hadir</span> pada {{ $today->translatedFormat('l, d M Y') }} — beserta ruang yang dijaga.</p>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white dark:divide-gray-800 dark:bg-gray-900">
                        @forelse ($attendances as $index => $attendance)
                            <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                <td class="px-4 py-3 text-sm"><x-badge-status status="hadir" /></td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-8 text-center text-sm text-gray-500 dark:text-gray-400">Tidak ada pengawas hadir hari ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
