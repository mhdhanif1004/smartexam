<x-layouts.kepala_sekolah title="Daftar Siswa Hadir Hari Ini">
    <div class="space-y-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Daftar Siswa Hadir Hari Ini</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Siswa dengan status kehadiran <span class="font-semibold text-emerald-600">hadir</span> pada {{ $today->translatedFormat('l, d M Y') }} — beserta ruang ujian.</p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white dark:divide-gray-800 dark:bg-gray-900">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-4 py-8 text-center text-sm text-gray-500 dark:text-gray-400">Tidak ada siswa hadir hari ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
