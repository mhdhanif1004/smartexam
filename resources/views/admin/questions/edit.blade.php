                    ...
                    <div class="mt-5 space-y-3">
                        <template x-for="(pair, index) in pairs" :key="index">
                            <div class="flex items-center gap-2">
                                ...
                                <img x-show="pair.left_image && !opt['ml_'+index]" :src="'/storage/'+pair.left_image" class="h-8 w-8 rounded border border-gray-200 object-contain dark:border-gray-700" alt="Kiri {{ $question->id }}">
                                <img x-show="pair.right_image && !opt['mr_'+index]" :src="'/storage/'+pair.right_image" class="h-8 w-8 rounded border border-gray-200 object-contain dark:border-gray-700" alt="Kanan {{ $question->id }}">
