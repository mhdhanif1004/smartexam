    ...
    <div class="space-y-6">
        ...
        >
            ...
            <div x-show="type === 'essay'" x-cloak class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-5">
                    <textarea id="essay_answer" name="essay_answer" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Tulis kunci jawaban...">{{ old('essay_answer') }}</textarea>
                </div>
