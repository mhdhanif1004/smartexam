<x-layouts.admin title="Edit Jadwal Ujian">
    <div class="space-y-6">
        <div>
            <h2 class="text-xl font-bold text-gray-900">Edit Jadwal Ujian</h2>
            <p class="mt-1 text-sm text-gray-500">Perbarui jadwal pelaksanaan ujian.</p>
        </div>
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input id="class_name" name="class_name" list="class-list" type="text" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('class_name', $examSchedule->class_name) }}" placeholder="contoh: XI RPL 1">
