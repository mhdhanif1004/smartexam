<x-layouts.admin title="Tambah Jadwal Ujian">
    <div class="space-y-6">
        <div>
            <h2 class="text-xl font-bold text-gray-900">Tambah Jadwal Ujian</h2>
            <p class="mt-1 text-sm text-gray-500">Atur jadwal ujian untuk mata pelajaran, kelas, dan ruangan tertentu.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.exam-schedules.store') }}" class="max-w-2xl space-y-6">
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select id="room_id" name="room_id" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input id="class_name" name="class_name" list="class-list" type="text" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('class_name') }}" placeholder="contoh: XI RPL 1">
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.exam-schedules.index') }}" class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50">Batal</a>
