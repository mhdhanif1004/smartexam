<x-layouts.admin title="Edit Kelas">
    <div class="space-y-6">
        <div>
            <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Edit Kelas</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Perbaiki nama kelas. Siswa yang sudah memakai kelas ini akan ikut diperbarui otomatis.</p>
        </div>
