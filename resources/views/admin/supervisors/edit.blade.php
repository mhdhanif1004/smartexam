<x-layouts.admin title="Edit Pengawas">
    <div class="space-y-6">
        <div>
            <h2 class="text-xl font-bold text-gray-900">Edit Pengawas</h2>
            <p class="mt-1 text-sm text-gray-500">Perbarui data akun pengawas. Penugasan ruangan dikelola lewat halaman Tambah/Edit Ruangan.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.supervisors.update', $supervisor) }}" class="max-w-2xl space-y-6">
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <label class="mt-5 flex w-fit items-center gap-2">
                    <input type="checkbox" name="is_active" value="1" @checked(old('is_active', $supervisor->user?->is_active)) class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
