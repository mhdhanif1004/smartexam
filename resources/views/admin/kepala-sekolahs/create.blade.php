<x-layouts.admin title="Tambah Kepala Sekolah">
    <div class="space-y-6">
        <div>
            <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Tambah Kepala Sekolah</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Akun pengguna ber-role kepala sekolah akan dibuat otomatis.</p>
        </div>

        <form
            method="POST"
            action="{{ route('admin.kepala-sekolahs.store') }}"
