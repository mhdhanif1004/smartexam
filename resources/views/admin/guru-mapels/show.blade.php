    ...
    <div class="space-y-6">
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-3 dark:border-gray-800">
                <div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Penugasan Mengajar (Mapel - Kelas)</h3>
                    <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">Mapel yang diampu guru beserta kelas yang diajar.</p>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white dark:divide-gray-800 dark:bg-gray-900">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-4 py-8 text-center text-sm text-gray-500 dark:text-gray-400">Belum ada penugasan mapel-kelas untuk guru ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
