...
<head>
    ...
    <title>Pratinjau Kartu Login Pengawas - SmartExam</title>
    <style>
    ...
    <div class="page">
        <div class="preview-header">
            ...
            <div class="preview-title">
                <h1 class="title">Kartu Login Pengawas</h1>
                <p class="sub">Kartu Login Pengawas Ujian CBT &middot; {{ count($supervisors) }} pengawas &middot; Dicetak {{ $tanggalCetak }}</p>
            </div>
            <div class="actions">
