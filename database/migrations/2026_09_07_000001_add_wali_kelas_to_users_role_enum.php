...
{
    /**
     * Tambahkan role baru `wali_kelas` ke kolom role (MySQL ENUM) pada tabel
    ...
    {
        DB::statement("ALTER TABLE users MODIFY role ENUM('admin','pengawas','peserta','guru_mapel','kepala_sekolah','wali_kelas') NOT NULL DEFAULT 'peserta'");
    }
