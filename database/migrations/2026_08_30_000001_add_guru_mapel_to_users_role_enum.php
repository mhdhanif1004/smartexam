...
{
    /**
     * Tambahkan role baru `guru_mapel` ke kolom role (MySQL ENUM) pada tabel
    ...
    {
        DB::statement("ALTER TABLE users MODIFY role ENUM('admin','pengawas','peserta') NOT NULL DEFAULT 'peserta'");
    }
};
